...
(async () => {
	const { data: lastCommit } = await axios.get('https://api.github.com/repos/SAGOR-KINGx/GOAT-V2/commits/main');
	...
	const { data: versions } = await axios.get('https://raw.githubusercontent.com/SAGOR-KINGx/GOAT-V2/main/versions.json');
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/SAGOR-KINGx/GOAT-V2/raw/main/${filePath}`, {
	...
	const { data: packageHTML } = await axios.get("https://github.com/SAGOR-KINGx/GOAT-V2/blob/main/package.json");
